...
4. [整團 NS 軸](整團NS軸/README.md)：實際角色的四補／五補／六補接力；目前可直接查看 [H8 六補軸](整團NS軸/本團/H/劇毒8王%286補%29.txt)與 [M5 四補軸](整團NS軸/本團/M/劇毒5王.txt)。
...
| 劇毒 M6 | 完成（mechanics-ready） | 治療模型完成 | 待建立 | 待建立 | 待建立 |
