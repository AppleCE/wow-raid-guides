...
版本：正式服 `12.1.0`。最後整理：`2026-09-21（Asia/Taipei）`。
...
4. [整團 NS 軸](整團NS軸/README.md)：實際角色的四補／五補／六補接力；目前可直接查看 [H8 六補軸](整團NS軸/本團/H/劇毒8王%286補%29.txt)、[M5 四補軸](整團NS軸/本團/M/劇毒5王.txt)與 [M6 四補草案](整團NS軸/本團/M/劇毒6王.txt)。
...
| 劇毒 M7 | 通用草案；三團723次失敗的前中後期時間分布 | 影片操作與正常重疊、目標看護草案 | 待建立 | 待建立 | 待建立 |
...
- [M 傳奇難度補職攻略](補職攻略/M/README.md)：固定四補角色頁；[M1 四補分配](補職攻略/M/補師分配/M1_Nekzali.md)、[M2 四補分邊草案](補職攻略/M/補師分配/M2_Entombed_Sentinels.md)、[M3 四補分配](補職攻略/M/補師分配/M3_The_Lost_Explorers.md)與 [M6 四補分配](補職攻略/M/補師分配/M6_The_Twin_Fangs.md)分王維護。
