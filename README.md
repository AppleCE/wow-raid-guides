...
版本：正式服 `12.1.0`。最後整理：`2026-09-25（Asia/Taipei）`。

## 從這裡開始

1. [完整首領攻略](#完整首領攻略)：第一次進場先看懂完整機制、階段循環與長場波次。
2. [每王治療分析](#每王治療分析)：正常治療缺口、機制死亡、團減與單點責任。
3. [補職攻略](補職攻略/README.md)：先選 [H](補職攻略/H/README.md) 或 [M](補職攻略/M/README.md)；分開查看角色責任、主責、備援與交接條件。
4. [整團 NS 軸](整團NS軸/README.md)：實際角色的四補／五補／六補接力；目前可直接查看 [H8 六補軸](整團NS軸/本團/H/劇毒8王%286補%29.txt)、[M5 四補軸](整團NS軸/本團/M/劇毒5王.txt)、[M6 四補草案](整團NS軸/本團/M/劇毒6王.txt)與 [M7 Arita 五補草稿](整團NS軸/本團/M/劇毒7王.txt)。
5. 個人 NS 軸：H 只維護[補薩](補職攻略/H/補薩/NS軸/H/README.md)與[龍補](補職攻略/H/龍補/NS軸/H/README.md)兩份通用版；M 以固定四補角色攻略與本團整團 NS 為準。
6. [團隊補招與減傷時間軸](整團時間軸/README.md)：按 H／M 與首領查詢王技能、五／六補、團減及個減。
7. [盤蛇島 22 個寶藏攻略](世界內容/盤蛇島/22個寶藏攻略.md)：依建議移動路線排列，包含完整解謎步驟與可直接貼入遊戲的座標。
8. [團本 FPS 畫面建議設定](UI設定/團本FPS畫面建議設定.md)：可直接照表調整 WoW 原生團本畫面設定。
9. [拓荒統計](拓荒統計/README.md)：世界前 50／100／200／400／500 公會各王傳奇拓荒把數，不定期更新；[互動版](https://applece.github.io/wow-raid-guides/%E6%8B%93%E8%8D%92%E7%B5%B1%E8%A8%88/)可查逐公會把數。
...
| 劇毒 H8 | 完成 | 完成 | 六補分配完成 | 通用個人軸待依實戰校正 | 六補 RL／NS 草案完成；五補保留備案 |
...
| 劇毒 M7 | 通用草案；三團723次失敗的前中後期時間分布 | 影片操作與正常重疊、目標看護草案 | Arita 五補分配草稿 | 五補共用整團 NS | 外團波次五補草稿；待本團 WCL 校準 |
| 劇毒 M8 | 隨進度新增 | 隨進度新增 | 隨進度新增 | 隨進度新增 | 隨進度新增 |

「完成」表示已有當前版本機制與可用 WCL 骨架，不表示補軸永久定案；取得本團拓荒 WCL 後仍會逐波復盤。

每次修改補招、角色或時間，會同步更新個人攻略、整團 NS 與 RL 時間軸／列表；補薩、龍補另同步通用個人 NS，核對一致後才發布。
...
- [劇毒 7 王 M：前、中、後期滅團時間分布](首領/劇毒7王_The_Coiled_Altar/M/整團分析.md)（三團723滅＋3次首殺；按拓荒日期分段，尚未作逐場死因歸因）
...
完整攻略說明全場流程與第一次進場重點；補招用途、補師盯人和自保判斷仍以同資料夾的治療分析為準。

## 世界內容

- [盤蛇島 22 個寶藏攻略](世界內容/盤蛇島/22個寶藏攻略.md)
...
- [劇毒 8 王 H：Ula'tek](首領/劇毒8王_Ulatek/H/治療分析.md)
...
- [M 傳奇難度補職攻略](補職攻略/M/README.md)：M1–M6 核心四補；[M1 四補分配](補職攻略/M/補師分配/M1_Nekzali.md)、[M2 四補分邊草案](補職攻略/M/補師分配/M2_Entombed_Sentinels.md)、[M3 四補分配](補職攻略/M/補師分配/M3_The_Lost_Explorers.md)、[M6 四補分配](補職攻略/M/補師分配/M6_The_Twin_Fangs.md)與 [M7 Arita 五補分配草稿](補職攻略/M/補師分配/M7_The_Coiled_Altar.md)分王維護。
