...
劇毒深淵 M 團固定四補：Arielle／愛麗（補聖）、呆小鄭（神牧）、菈菈跳來跳去（補德）、豆腐天尊（補僧）。浪縛岩窟 M 為 15–25 人彈性例外：本團預計 25 人並沿用 H8 六補，加入 Raitoningu、血薩靈兩名補薩。劇毒深淵若另需第五補，才由血薩靈切補薩，且必須重排整條軸。
...
- [菈菈跳來跳去：補德](補德/攻略.md)
- [豆腐天尊：補僧](補僧/攻略.md)
- [補薩：劇毒 M3 個人通用軸](補薩/M3_通用.md)（第五補候選；套用前改成實際角色 tag）

## 目前涵蓋

| 首領 | 狀態 | 使用方式 |
| --- | --- | --- |
| [浪縛單王 Nymrissa](../../首領/浪縛單王_Nymrissa_Wavecaller/M/完整攻略.md) | `draft` | [治療分析](../../首領/浪縛單王_Nymrissa_Wavecaller/M/治療分析.md)｜[六補分配](補師分配/Nymrissa_Wavecaller.md)｜[整團時間軸](../../整團時間軸/M/浪縛單王.md)｜[六補 NS](../../整團NS軸/本團/M/浪縛單王.txt)；待第一晚本團 WCL 校準 |
